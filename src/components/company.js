                ...
                <div className="container clearfix">
                    <div className="col_clear clearfix">
                        <div className="colm_9">
                                ...
                                <div className="summery">
                                    ...
                                    <div className="company_detil">
                                        ...
                                        <ul>
                                            ...
                                            <li><i className="fa fa-tags"></i>Blockchain, Cryptocurrency</li>
                                            <li><i className="fa fa-users"></i>10-50 employees</li>
                                        </ul>
                                    </div>
                            ...
                            <div className="seactions">
                                <div className="heading_section"><h2>Team</h2></div>
                                <div className="team_wrap clearix">
                                    <h4>Founder</h4>
                                    <div className="team">
                                        <a href="/profile">
                                            <img src="https://images.pexels.com/photos/326055/pexels-photo-326055.jpeg?auto=compress&cs=tinysrgb&h=350" />
                                            <h5>Bobo Smith <span>CEO</span></h5>
                                        </a>
                                    </div>
                                    <div className="team">
                                        <a href="/profile">
